...
2. Pour le mainteneur des dépôts -> ajouter les credentials de l'API Scaleway dans les variables du dépôts Gitlab `image` : `Settings -> CI / CD -> Variables`:
    - **SCW_DEFAULT_PROJECT_ID** : Votre Project ID Scaleway (https://console.scaleway.com/project/settings)
    - **SCW_ACCESS_KEY** : Votre Access key Scaleway (https://console.scaleway.com/account/credentials)
    - **SCW_SECRET_KEY** : Votre Secret key Scaleway (https://console.scaleway.com/account/credentials)
    - **SCW_DEFAULT_ZONE** : fr-par-1

3. Pour le mainteneur des dépôts -> ajouter les credentials de l'API Scaleway dans les variables du dépôts Gitlab `infrastructure` : `Settings -> CI / CD -> Variables`:
...
4. Pour le mainteneur des dépôts -> ajouter les credentials de l'API Scaleway dans les variables du dépôts Gitlab `application` : `Settings -> CI / CD -> Variables`:
    - **ANSIBLE_HOST_KEY_CHECKING** : False
    - **SCW_DEFAULT_ORGANIZATION_ID** : Votre Project ID Scaleway (https://console.scaleway.com/project/settings)
    - **SCW_DEFAULT_ZONE** : fr-par-1
    - **SCW_TOKEN** : Votre Secret key Scaleway (https://console.scaleway.com/account/credentials)
